...
#### This web page is hosted [here!](https://shikharjustdoit.netlify.app/)

- View the local installation in the [CONTRUBUTING.md]https://github.com/shikhar-lab/To-DO-LIST
...
Check [Issues](https://github.com/shikhar-lab/To-DO-LIST/issues) for contributing to this repository.
...
- View the [`CONTRIBUTING.md`](https://github.com/shikhar-lab/To-DO-LIST/pulls) for further instructions, requirements/dependencies & local project setup instructions!
- All the contributors to this repository can be found in the [`CONTRIBUTORS.md`](https://github.com/shikhar-lab/To-DO-LIST/pulls) file!
