...
- Have a look at the [Issues](https://github.com/shikhar-lab/To-DO-LIST/issues) section for issues that need to be solved!
...
- Before you make any changes, [keep your fork in sync](https://www.freecodecamp.org/news/how-to-sync-your-fork-with-the-original-git-repository/) to avoid merge conflicts:
    ...
    ```bash
    git remote add upstream https://github.com/shikhar-lab/ToDoList.git
    git fetch upstream
